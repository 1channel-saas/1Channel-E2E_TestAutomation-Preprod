...
public class AddEstimateActivity_CustomerDashboard_Object extends DriverBase {

    @FindBy(xpath = "//span[text()=\" CRM \"]")
    WebElement CRM_menu;

    @FindBy(xpath = "//div/ul/li/a[@href=\"/customers\"]")
    WebElement Customer_Submenu;

    @FindBy(xpath = "//div[@id=\"kt_subheader\"]//child::h5")
    WebElement customerPage_headerText;
    ...
    public AddEstimateActivity_CustomerDashboard_Object() {
    ...
    public void User_clicks_on_menu_crm_and_submenu_customers() {
        ...
        Customer_Submenu.click();
        commonUtils.sleep(5000);
    }

    public void User_is_on_customers_page() {
        boolean customer_textHeaderisDisplayed = customerPage_headerText.isDisplayed();
        Assert.assertTrue(customer_textHeaderisDisplayed);
    }
    ...
    public void Select_update_exp_closure_date_from_calendar_under_estimate(String current_date) {
