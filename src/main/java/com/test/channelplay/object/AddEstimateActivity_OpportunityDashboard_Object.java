...
public class AddEstimateActivity_OpportunityDashboard_Object extends DriverBase {

    @FindBy(xpath = "//span[text()=\" CRM \"]")
    WebElement CRM_menu;

    @FindBy(xpath = "//div/ul/li/a[@href=\"/opportunities\"]")
    WebElement Opportunity_Submenu;

    @FindBy(xpath = "//div/div/h5[text()=\" Opportunities \"]")
    WebElement opportunityPage_headerText;
    ...
    @FindBy(xpath = "//div/label[text()=\"Select Customer\"]/parent::div/following-sibling::div//child::div//child::mat-select/div/div[1]/span/span")
    WebElement selectCustomer_dropdown;
    //"//div/label[text()="Select Customer"]/parent::div/following-sibling::div//child::mat-select//child::span[text()="user nbhxt"]"
    @FindBy(xpath = "//div/label[text()=\"Select Opportunity\"]/parent::div/following-sibling::div//child::mat-select/div/div[1]/span/span")
    ...
    public AddEstimateActivity_OpportunityDashboard_Object() {
    ...
    public void User_clicks_on_menu_CRM_and_submenu_Opportunities() {
        ...
        Opportunity_Submenu.click();
        commonUtils.sleep(5000);
    }

    public void User_is_on_Opportunities_page() {
        boolean opportunity_textHeaderisDisplayed = opportunityPage_headerText.isDisplayed();
        Assert.assertTrue(opportunity_textHeaderisDisplayed);
    }
    ...
    public void Check_select_customer_is_locked_and_customer_name_is_displayed() {
        String selectCustomer_name = selectCustomer_dropdown.getText();
        Assert.assertTrue(selectCustomer_dropdown.isDisplayed());
        System.out.println("Selected customer name: " +selectCustomer_name+"--------------");
        commonUtils.sleep(2000);
    }

    public void Check_select_opportunity_is_locked_and_opportunity_name_is_displayed() {
        String selectOpportunity_name = selectOpportunity_dropdown.getText();
        Assert.assertTrue(selectOpportunity_dropdown.isDisplayed());
        System.out.println("Selected opportunity name: " +selectOpportunity_name+"--------------");
        commonUtils.sleep(2000);
    }
    ...
    public void Select_update_exp_closure_date_from_calendar_under_opportunity_estimate(String current_date) {
        updateExpClosureDate_Calender_button.click();
        commonUtils.sleep(2000);
        WebElement expClosureDatePick = getDriver().findElement(By.xpath("//table[@class=\"mat-calendar-table\"]/tbody/tr/td/div[contains(text(), '" +current_date+ "')]"));
