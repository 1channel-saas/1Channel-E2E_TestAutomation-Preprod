...
public class CRMPortalLoginObject extends DriverBase {
    private static final Logger log = LoggerFactory.getLogger(CRMPortalLoginObject.class);
    ...
    public void loginToCRM(String uid, String pass) {
        ...
        webDriverUtils.until(ExpectedConditions.elementToBeClickable(login_password));
        login_password.clear();
        login_password.sendKeys(pass);
        webDriverUtils.until(ExpectedConditions.elementToBeClickable(SignIn));
        SignIn.click();
