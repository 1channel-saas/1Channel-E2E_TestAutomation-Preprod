...
public class CommonStepDefinitions_API {
    private static final Logger logger = LoggerFactory.getLogger(CommonStepDefinitions_API.class);
...
//    This is common step definitions which can be directly accessed with below mentioned gherkin.
    ...
    public CommonStepDefinitions_API() {
