...
#    DB
    Then validate whether bulk data upload performed by "<assignedUserId>" saved under "channelplay_aurora.b2b_company_master_stage" table with "<AccNo1>" "<AccNo2>" "<AccNo3>" "<AccNo4>" "<AccNo5>" and "<uploadDateTime>" "<uploadDate>" for INB
    ...
    Then validate whether bulk data upload performed by "<assignedUserId>" saved under "channelplay_aurora.b2b_company_master" table from staging table with "<AccNo1>" "<AccNo2>" "<AccNo3>" "<AccNo4>" "<AccNo5>" and "<uploadDateTime>" "<uploadDate>" for INB

    Examples:
      |username        |password|projectIdInUse|assignedUserId|AccNo1    |AccNo2    |AccNo3    |AccNo4    |AccNo5    |uploadDateTime     |uploadDate|
      |inbsom@gmail.com|12345678|433           |6352          |9112202002|9112202003|9112202005|9112202009|9112202008|2025-02-12 02:53:08|20250214  |
